...
| S05 | Level 15-19 | A05, A06, A07, A08, A10 | Controlled early faction depth and Septimus / `Discerning the Transmundane` staging window. | If `Discerning the Transmundane` reaches the cube/opened-outpost state, do not leave the Oghma path for long-term delay. Acquire the Oghma Infinium only when the path is being resolved; leave read/use timing to TB-027 skill/perk planning. Keep Bards instruments uncollected before assignment. | TB-025, TB-026, TB-027, TB-032 |
...
| S14 | Level 80-251 | A20, A21 | Ebony Warrior, late counters, remaining high-risk objectives, and controlled progression toward all perks. | Legendary reset distribution, final crafting, investment sweeps, enchantment source selection, and alchemy recipes remain deferred to TB-027/TB-030. | TB-027, TB-030 |
| S15 | Level 252+ / final completion state | A20, A21 | All-perks and final reconciliation band. | Final state must restore all skills to 100 after Legendary resets, allocate all 251 skill perk ranks, preserve unique-item policy, and map every objective/checklist row to a route, branch, option list, appendix, or exclusion. | TB-030, TB-033 |
...
Branch anchors remain placeholders for TB-028/TB-029. This skeleton only assigns where their hard-save pressure belongs.
...
| Aetherium Forge | S11 | S11 or later Dawnguard-compatible band. | Aetherial reward hard save; no Crown/Shield/Staff default chosen yet. | TB-028 chooses Crown, Shield, or Staff default and branch treatment. |
| Hircine / Bloated Man's Grotto | S04 | S04-S10 only after Bolar/grotto state and artifact policy are settled. | Bolar's Oathblade / grotto-state policy, Hircine artifact policy, and branch save. | TB-028 chooses Hircine artifact policy; TB-032 places grotto/cell-state warning. |
...
| All-perks progression | S14-S15 reserve level 252 and Legendary reset recovery for the endgame. | Exact reset distribution, skill recovery loops, final perk order, and exploit policy remain TB-027. |
| Crafting and economy | Early trophy crafts can occur before final crafting power; final crafting/investment/enchantment/alchemy should wait for their own layer. | Exact source items, recipes, merchant investment circuit, materials, and final gear remain TB-027/TB-030. |

## Handoff to TB-025

TB-025 should reshape this skeleton around Survival Mode geography without violating the gates above. It should:
...
* leave branch defaults, detailed warning prose, flexible objective insertion, skill-reset distribution, and checklist mapping to their assigned tasks.
