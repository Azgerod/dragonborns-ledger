...
| Branch defaults still defer to TB-028 where marked unresolved. | Do not choose canonical Hircine, Aetherial, Thirsk, Bittercup, Velehk Sain, or similar defaults in TB-024. |
...
| A14 | Dawnguard faction and Aetherium branch | Place Dawnguard/Volkihar branch gate and Dawnguard finite chains. | Hard save at `Bloodline`; canonical route refuses Harkon's gift; Volkihar branch holds branch-only radiants/rewards; complete Dawnguard finite chains; keep Aetherium Forge save because reward default is unresolved. | `data/constraints/quest-conflicts-hard-saves.md` (`SN-000097`, `SN-000099`); `data/constraints/radiant-boundaries.md` (`SN-000114`); `data/constraints/trophy-dependencies.md` (`SN-000105`) | TB-024, TB-028, TB-029 |
...
| Option lists | Not placed. | TB-028/TB-030 choose defaults for spouse, children, stewards, role assignments, and isolated moral choices. |
