...
Status: TB-034 minimal numbered route prototype complete, built from the TB-033 validated block-level progression, counter-mechanics, location route-validation, checklist source-readiness, warning, and hard-save overlay. Machine-readable objective assignments remain in `data/route-planning/prototype-objective-block-map.csv`.

This is a Phase 13 minimal route prototype. It contains a numbered route frame plus the supporting Phase 7 flexible-objective insertion, Phase 8 progression, Phase 10 counter/location-validation, Phase 11 warning, and Phase 12 validation overlays. It is not final guide prose, not pathfinding, and not a final checklist step map.

The purpose of the TB-034 pass is narrow: convert the validated `G00` through `G14` route frame into reviewable section headings and numbered steps with objective names, level gates, hard saves, checklist categories, and stop/return points only. The older block maps and overlays remain below as source support for later TB-035 prose expansion and TB-037 final QA.
...
## TB-034 Minimal Numbered Route Prototype

This section is the TB-034 deliverable. Step numbers are prototype numbers, not final guide numbering. Each row gives only the route action, objective names or objective families, gates/saves, checklist categories, and stop/return points needed to test whether the run fits together.

| Step | Block / gate | Objective names and route action | Checklist categories | Stop / return point |
| --- | --- | --- | --- | --- |
| MR-001 | G00 setup | Confirm official AE bundle only, no non-AE Creations or mods, Legendary difficulty, Survival Mode baseline, rotating manual saves, and trophy-safe setup. | Trophy, AE Creation, Survival | Start the run only after setup is stable. |
| MR-002 | G01 opening | Complete `Unbound` and `Before the Storm`; establish first bed, food, warmth, carry, and sell-off support. | Quest, Survival | Do not start broad collection or cold travel. |
| MR-003 | G01 Whiterun first-entry | Enter Whiterun as a controlled local sweep: handle or preserve Amren, Ysolda, Brenuin, Uthgerd, and early work-action targets. | Misc, Favor, Trophy, Relationship | Leave Whiterun only after first-visit exposure is deliberate. |
| MR-004 | G01-G02 main quest opener | Complete `Bleak Falls Barrow` and `Dragon Rising` when the warm-core support loop is ready. | Quest, Trophy, Shout | Dragons are now active; route dragon souls deliberately. |
| MR-005 | G02 central support | Buy the Whiterun Stable Horse, acquire and verify Breezehome storage, then use Tundra Homestead only after purchase and storage verification. | Property, Survival, Storage | Do not store uniques in an unverified container. |
| MR-006 | G02 central activities | Complete representative `Chop Wood`, crop sale, brawl, beggar favor, drunk favor, early crafting/tutorial, and local Whiterun/Riverwood support actions. | Misc, Trophy, Crafting, Relationship | Reserve trophy-pop fallback saves for one-shot counters. |
| MR-007 | G02 level 8 gate | At level 8+, route Silent Moons/Lunar weapon handling and the central Whiterun/Rorikstead location queue. | Location, Unique Item, Enchantment | Do not first loot or clear Silent Moons before level 8. |
| MR-008 | G02 Goldenhills | Complete `The Unquiet Dead`, claim Goldenhills Plantation, set up farm operations, and use it as food/income support after verification. | AE Creation, Property, Food, Income | Do not treat Goldenhills as the main display base. |
| MR-009 | G02-G03 Companions start | Start Companions through `Take Up Arms`, `Proving Honor`, and the required early radiant gates. | Quest, Faction, Radiant | Stop before any cure or transformation loss. |
| MR-010 | G03 Companions window | Continue Companions through the werewolf path, preserve Beast Form, and keep Totems/Purity plus Werewolf Mastered for the later transformation window. | Quest, Trophy, Spell/Power, Radiant | Final mortal state waits until both transformation trees are complete. |
| MR-011 | G03 Falkreath/Lakeview | Secure Siddgeir/Falkreath favor and Lakeview Manor prerequisites before Dark Brotherhood `Kill Helvard` pressure. | Property, Favor, NPC | Do not kill Helvard before Lakeview state is secure. |
| MR-012 | G03 southern sweep | Route Falkreath, Riverwood, Ivarstead, and southern warm objectives, including local books, locations, and Lakeview construction staging. | Location, Book, Property, Misc | Keep mountain/cold interiors prepared, not incidental. |
| MR-013 | G03 Hircine setup | Before `Ill Met By Moonlight`, acquire Bolar's Oathblade and preserve the normal Bloated Man's Grotto clear state; use `HS-DAEDRIC-HIRCINE-GROTTO` when resolving the outcome. | Unique Item, Location, Daedric | Branch Savior's Hide first, reload, then keep Ring of Hircine. |
| MR-014 | G04 Riften access | Enter Riften, establish services/property candidates, and start Thieves Guild with `A Chance Arrangement` and `Taking Care of Business`. | Quest, Faction, Property | Do not push into Nightingale gates yet. |
| MR-015 | G04 Thieves early chain | Complete `Loud and Clear`, `Dampened Spirits`, `Scoundrel's Folly`, and `Speaking With Silence`; begin city-job tallies with save/reload targeting. | Quest, Radiant, Trophy | Stop before `Hard Answers`; the next primary quest awards the Nightingale Blade and pulls the late Thieves chain to the level-46 source-tier gate. |
| MR-016 | G04 southeast sweep | Route safe Riften/Rift locations, Honeyside/Shadowfoot candidates, Frost/`Promises to Keep` with `HS-RIFT-FROST-LETRUSH`, local books, and support objectives. | Location, Property, Book, Unique Item, Mount | Keep Frost on the main save; keep Dawnguard/Aetherium branch content out of this block. |
| MR-017 | G04 level 32 checkpoint | Treat level 32+ as the Nightingale Armor readiness threshold only; keep the primary Thieves chain parked because `Hard Answers` and the Nightingale Blade must precede `Trinity Restored`. | Unique Item timing, Progression | Resume the late Thieves chain in MR-039 under the conservative level-46 source-tier policy. |
| MR-018 | G05 Reach setup | Establish Markarth and Old Hroldan support, route safe Reach locations, and acquire Vlindrel Hall only after local validation. | Location, Property, Book | Do not enter Sky Haven Temple before level 46. |
| MR-019 | G05 Cidhna/Molag/Namira | Route Cidhna Mine, `The House of Horrors`, and `The Taste of Death` only with the source-backed saves and NPC warnings active. | Quest, Daedric, Unique Item | Use `HS-DAEDRIC-NAMIRA-FEAST` before Namira outcome. |
| MR-020 | G05 Aetherium setup | Start `Lost to the Ages`, collect Aetherium shards as route-safe, and hold the forge decision for the Dawnguard/later reward branch step. | Quest, Unique Item, Location | Do not craft the Aetherial item before `HS-AETHERIUM-FORGE`. |
| MR-021 | G05 Daedric matrix | Route `A Daedra's Best Friend`, `The Black Star`, `The Break of Dawn`, `The Only Cure`, `Pieces of the Past`, `A Night To Remember`, `The Whispering Door`, `The Cursed Tribe`, `The Mind of Madness`, `Boethiah's Calling`, and related Daedric objectives only after level, sacrifice, and branch-save requirements are met. | Daedric, Artifact, Trophy | Use `HS-DAEDRIC-CLAVICUS`, `HS-DAEDRIC-BLACK-STAR`, and `HS-DAEDRIC-MEHRUNES-SHRINE`; pick a nonessential Boethiah sacrifice. |
| MR-022 | G06 Windhelm state | Complete `Blood on the Ice` and Hjerim purchase/furnishing in one controlled Windhelm block before Civil War end-state, Dragonborn main start, or Dark Brotherhood fallout. | Quest, Property, Bug Warning | Save before Hjerim entry and verify ownership/furnishing. |
| MR-023 | G06 main quest staging | Advance the main quest through `The Way of the Voice`, `The Horn of Jurgen Windcaller`, `A Blade in the Dark`, `Diplomatic Immunity`, and `A Cornered Rat`; stop before Sky Haven/Alduin's Wall. | Quest, Shout, Trophy | Return to `Alduin's Wall` only at level 46+. |
| MR-024 | G06 Eastmarch support | Complete Malborn's follow-up after `Diplomatic Immunity`, route Eastmarch/Windhelm locations, Gallows Hall, Hjerim support, books, and ferry preparation. | Location, AE Creation, Property, Book | Do not start broad Solstheim cleanup from the ferry hub. |
| MR-025 | G07 Solitude prerequisites | Complete Solitude favors and dependencies, including `The Spiced Wine`, Captain Aldis-linked work, and Erikur-sensitive Thieves/Solitude timing. | Favor, NPC, Quest | Finish before hostile Solitude states or `Bound Until Death`. |
| MR-026 | G07 Bards College | Join Bards College, then collect King Olaf's Verse, Finn's Lute, Pantea's Flute, and Rjorn's Drum only after assignment. | Quest, Book, Trophy | Save before induction and each instrument dungeon. |
| MR-027 | G07 Shield gate | Route `The Wolf Queen` line, but take Falk's final `The Wolf Queen Awakened` reward only at level 40+. | Quest, Unique Item | Stop before Shield of Solitude if below level 40. |
| MR-028 | G07 northwest sweep | Route Solitude, Dragon Bridge, Morthal, marsh, coastal, Windstad, Myrwatch, and local location/book queues with cold/carry prep. | Location, Property, Book, Misc | Keep Bards and Civil War state warnings local. |
| MR-029 | G07 Dark Brotherhood fork | After `Delayed Burial`, Lakeview/Helvard prerequisites, Solitude dependencies, and Erikur-sensitive work are settled, make `HS-DB-ABANDONED-SHACK`. | Branch, Quest, Trophy | Play Destroy branch first, reload, then join Dark Brotherhood. |
| MR-030 | G07-G10 Dark Brotherhood main | On the main save, join Dark Brotherhood, complete the join-route questline, contracts, Shadowmere, and DB rewards. | Quest, Faction, Unique Item, Mount | Do not let `Bound Until Death` precede Solitude/Erikur prerequisites. |
| MR-031 | G08 north preflight | Prepare for Pale/Winterhold cold travel with bed, food, hot soup, warmth, cure/healing, carry, and return support. | Survival, Location | Do not treat cold corridors as casual filler. |
| MR-032 | G08 College opening | Enter the College with `First Lessons`; hold `Under Saarthal` and Forbidden Legend-linked state until level 36 under current constraints. | Quest, Faction, Spell | Do not read `Lost Legends` or approach linked sites before level 36. |
| MR-033 | G08 Pale/Dawnstar | Route Dawnstar, Heljarchen, Frostmere, Pale Blade, and Vaermina work with level 27+ and Kharjo target checks. | Location, Property, Daedric, Unique Item | Use `HS-DAEDRIC-VAERMINA-SKULL` before Vaermina outcome. |
| MR-034 | G08 level 25+ | Keep the Mage's Circlet hold active; claim it only after level 25 when the College route reaches `Good Intentions`. | Quest, Unique Item | Do not report `Good Intentions` below level 25. |
| MR-035 | G09 level 36 loop | At level 36+, complete `Under Saarthal`, `Forbidden Legend`, Folgunthur, Geirmund's Hall, Reachwater Rock, and the Gauldur rewards. | Quest, Location, Unique Item | Verify cold/rest/carry support before each linked dungeon. |
| MR-036 | G09 College completion | Finish College chain through `Hitting the Books`, `Good Intentions`, `Revealing the Unseen`, `Containment`, `The Staff of Magnus`, and `The Eye of Magnus`. | Quest, Faction, Spell/Power | Keep Mage's Circlet and linked-dungeon gates satisfied. |
| MR-037 | G09 College side/outcome | Route College side quests, ritual spell quests, master spells, and `Forgotten Names`; use `HS-COLLEGE-VELEHK-SAIN` and release Velehk on main save. | Quest, Spell, Unique Item | Kill-Velehk outcome stays optional unless final QA proves a gap. |
| MR-038 | G10 level 46 main quest | At level 46+, return to `Alduin's Wall`, first enter Sky Haven Temple, and acquire maximum Dragonbane. | Quest, Unique Item | Do not enter Sky Haven before this gate. |
| MR-039 | G10 level 46 Thieves | At level 46+, complete `Hard Answers`/Nightingale Blade, `The Pursuit`, Riftweald/Chillrend, `Trinity Restored`/Nightingale Armor, `Blindsighted`/Nightingale Bow, and `Darkness Returns`. | Quest, Unique Item, Location | Keep `HS-TG-ARTICULATION-REWARD` for Guild Master reward conversation. |
| MR-040 | G10 Guild restoration | Complete `Under New Management`, Guild Master reward, Amulet of Articulation save/reload policy, 20 city restoration jobs, and continue the 125-job counter plan. | Quest, Radiant, Unique Item, Trophy | Do not close the Thieves counter until TB-037 observed totals validate it. |
| MR-041 | G10 Civil War branch | Make `HS-CW-BEFORE-FACTION-OATH`; play the Stormcloak branch first, verify branch-only objectives, reload, then join Imperial on the main save. | Branch, Quest, Trophy | Preserve War Hero/Season Unending coordination. |
| MR-042 | G10 Imperial Civil War | Complete Imperial Civil War, War Hero-safe fort handling, Hero of Skyrim handling, and Imperial-aligned `Battle of the Champions` with `HS-AE-CIVIL-WAR-CHAMPIONS` if separated. | Quest, Trophy, AE Creation, Unique Item | Verify both equipment-set availability before final checklist closure. |
| MR-043 | G10 main quest coordination | Continue main quest through `The Throat of the World`, `Elder Knowledge`, `Alduin's Bane`, and `The Fallen`; if MR-042 completed the Civil War, `Season Unending` should be skipped. | Quest, Shout, Trophy | If Civil War was not completed, use the War Hero/hold-handoff save policy before any treaty outcome. |
| MR-044 | G10 Paarthurnax branch | Make `HS-MQ-PAARTHURNAX`; play the compact Blades/Paarthurnax branch first, verify `Rebuilding the Blades` and `Dragon Hunting`, reload, and preserve Paarthurnax. | Branch, Quest, Shout, Checklist | Keep Greybeards/Paarthurnax continuity on the main save. |
| MR-045 | G11 Dawnguard fork | Start Dawnguard and make `HS-DG-BLOODLINE`; play Volkihar branch first, including branch radiants, rings/amulets, and conditional `The Gift`, then reload and refuse Harkon. | Branch, Quest, Unique Item, Trophy | Spouse-state for `The Gift` must be valid or labeled conditional. |
| MR-046 | G11 Dawnguard main | Complete Dawnguard main-route chain, Fort Dawnguard support, finite side content, representative radiants, and Lost Relic cycling until all three relics are obtained. | Quest, Radiant, Unique Item, Trophy | Record filler radiants and avoid unbounded radiant grinding. |
| MR-047 | G11 Aetherium Forge | At the forge, make `HS-AETHERIUM-FORGE`; audit Staff and Shield branches, reload after each, then craft Aetherial Crown on the main save. | Branch, Artifact, Trophy | Keep only Aetherial Crown on canonical continuity. |
| MR-048 | G11 Dawnguard worldspaces | Route Soul Cairn, Arvak, Unknown Books, Forgotten Vale, Auriel's Bow, paragons, and Dawnguard location/book queues with expedition support. | Location, Book, Collectible, Unique Item | Save and shoot the sun after Auriel's Bow before long delay. |
| MR-049 | G11 transformations | Finish Werewolf Mastered, Vampire Mastered, Beast Form/totem coverage, and cure/final mortal-state setup after both transformation systems are recorded. | Trophy, Spell/Power, Transformation | Do not permanently cure before required perk trees are complete. |
| MR-050 | G12 Solstheim entry | Take the Windhelm ferry only with Raven Rock rest/food/carry support; establish Raven Rock and do not use Severin storage before ownership verification. | Survival, Location, Quest | Broad island cleanup waits for island infrastructure. |
| MR-051 | G12 Raven Rock core | Complete Dragonborn opening through `The Temple of Miraak`, Raven Rock setup, `The Final Descent`, `Served Cold`, Severin Manor verification, and local support rows. | Quest, Property, Unique Item, Location | Verify Severin beds/containers before using it as a base. |
| MR-052 | G12 Skaal/Stalhrim | Complete `The Fate of the Skaal`, immediately start/secure `A New Source of Stalhrim`, and verify stalhrim crafting unlock. | Quest, Crafting, NPC | Save before Abandoned Lodge and verify Deor/Fanari state. |
| MR-053 | G12 Thirsk branch | Make `HS-DRAGONBORN-THIRSK-CHOICE`; play the Riekling branch first, reload, then complete Nord-side `Retaking Thirsk` and Nord-side favors. | Branch, Quest, Relationship | Do not duplicate Nord-side favors on the branch. |
| MR-054 | G12 Tel Mithryn | Route Tel Mithryn, `Reluctant Steward`, `Old Friends`, Black Books, staff/imbuing support, and local spell/source rows. | Quest, Spell/Power, Book, Crafting | Save before Neloth locator/body-search sensitive steps. |
| MR-055 | G12 Unearthed/Ralis | Route `Unearthed` by phase, saving before each payment/re-entry; make `HS-DRAGONBORN-UNEARTHED-RALIS` before the final outcome and spare Ralis on main save. | Quest, Unique Item, Follower | Kill outcome remains optional unless final QA proves a gap. |
| MR-056 | G12 Solstheim sweep | Route Deathbrand, Karstaag, Black Books, Skaal/Thirsk/Tel Mithryn/Raven Rock locations, spell tomes, documents, and island collectibles. | Location, Book, Spell/Power, Collectible | Do not finish final Miraak before level 60. |
| MR-057 | G12 Ghosts branch | Make `HS-AE-GHOSTS-TEMPLE`; play destroy-heretics branch first and record `Reclamation Priest's Journal (AE)`, reload, then keep join/infiltrate on main save. | Branch, AE Creation, Book, Unique Item | Preserve main-route armory/crafting/follower access. |
| MR-058 | G12 Bittercup branches | Make `HS-AE-BITTERCUP-ALTAR`; play Power branch, reload; play Nothing branch, reload; continue Fortune on main save for Master Transmute coverage. | Branch, AE Creation, Spell, Unique Item | Do not keep Power or Nothing on the canonical save. |
| MR-059 | G12 level 60 Dragonborn final | At level 60+, complete `At the Summit of Apocrypha`, defeat Miraak, and acquire maximum Miraak equipment. | Quest, Unique Item, Spell/Power, Trophy | Do not make Miraak's corpse appear before level 60. |
| MR-060 | G13 main quest finale | Route `The World-Eater's Eyrie`, Skuldafn, Sovngarde, and `Dragonslayer` with separate-worldspace recovery planning. | Quest, Location, Trophy | Skuldafn is manual-validation geography, not ordinary Eastmarch routing. |
| MR-061 | G13 high-risk AE | Route `The Cause`, Deadlands, high-risk AE quest bundles, and separate-worldspace Creation content only after parent triggers and exit/recovery plans are checked. | AE Creation, Quest, Location, Unique Item | Do not auto-route from Skyrim/Solstheim proximity. |
| MR-062 | G13 Black Book power defaults | Confirm Black Book power defaults and temporary crafting/progression switches after all required Black Books and skill-book timing needs are satisfied. | Spell/Power, Book, Progression | Keep Waking Dreams resets for controlled late windows. |
| MR-063 | G14 location counters | Finish corridor-by-corridor clear/discovery cleanup for Delver, Explorer, Solstheim Explorer, and remaining map/location rows. | Location, Trophy | Do not count Angarvunde or Mistwatch for Delver; validate observed counters. |
| MR-064 | G14 collectibles | Reconcile opportunistic pickups and finish Stones of Barenziah, dragon priest masks, claws, bugs in jars, paragons, treasure maps, fishing, pets, mounts, shouts, word walls, and remaining finite sets. | Collectible, Pet/Mount, Shout, Trophy | Use appendices for verification, not as a reason to defer natural first-visit pickups. |
| MR-065 | G14 books/spells | Finish skill books under Scholar's Insight policy, spell tomes, quest/AE documents, Black Book checks, and final learned-spell verification. | Skill Book, Spell, Book, Checklist | Reader trophy check occurs after 50 unique skill books; all 90 titles remain required. |
| MR-066 | G14 crafting/progression | Finish enchantment learning from non-unique sources, alchemy effect discovery, merchant investments, practical crafting systems, and final material/output checks. | Enchantment, Alchemy, Crafting, Investment | Do not disenchant unique items for baseline learning. |
| MR-067 | G14 level 78/80 gates | At level 78+, complete Legendary Dragon; at level 80+, complete `The Ebony Warrior`. | Trophy, Quest, Combat | Save before each one-shot late combat/trophy action. |
| MR-068 | G14 all-perks loop | Execute late Legendary reset loop to level 252+, assign all 251 normal perk ranks, and restore all skills to 100 after resets. | Skill/Perk, Trophy, Progression | Do not finish with any reset skill below 100. |
| MR-069 | G14 household/property/services | Verify all homes, Hearthfire wings/services, steward/bard/carriage assignments, spouse, children, Goldenhills staffing, mounts, pets, and safe-storage/display state. | Property, Relationship, Pet/Mount, Checklist | Non-default options are TB-035 option-list material. |
| MR-070 | G14 Master Criminal branch | Make `HS-TROPHY-MASTER-CRIMINAL`; stage controlled 1000-gold bounties in all nine holds, verify trophy, then reload clean continuity. | Branch, Trophy | Avoid quest-critical NPC deaths and do not keep bounty state. |
| MR-071 | G14 final reconciliation | Perform final checklist synchronization, trophy-pop fallback checks, unique-item preservation audit, branch-return audit, appendix cross-check, and unresolved-risk handoff. | Checklist, Trophy, Unique Item, Branch | TB-037 through TB-043 validate the final guide after TB-035/TB-036. |

### Named Save Placement Check

| Save | Prototype step | Main continuity after branch or save use |
| --- | --- | --- |
| `HS-DB-ABANDONED-SHACK` | MR-029 | Reload and join the Dark Brotherhood. |
| `HS-DAEDRIC-NAMIRA-FEAST` | MR-019 | Reload and keep Ring of Namira outcome if used for artifact-safe main route. |
| `HS-DAEDRIC-CLAVICUS` | MR-021 | Reload and keep Masque of Clavicus Vile. |
| `HS-DAEDRIC-HIRCINE-GROTTO` | MR-013 or later Hircine return | Reload and keep Ring of Hircine single-artifact outcome. |
| `HS-DAEDRIC-MEHRUNES-SHRINE` | MR-021 Daedric matrix | Reload and reforge Mehrunes' Razor. |
| `HS-DAEDRIC-VAERMINA-SKULL` | MR-033 | Reload and take Skull of Corruption. |
| `HS-DAEDRIC-BLACK-STAR` | MR-021 Daedric matrix | Reload and keep The Black Star. |
| `HS-COLLEGE-VELEHK-SAIN` | MR-037 | Release Velehk for hidden treasure path. |
| `HS-TG-ARTICULATION-REWARD` | MR-040 | Reload until the selected Amulet of Articulation policy is satisfied. |
| `HS-CW-BEFORE-FACTION-OATH` | MR-041 | Reload and join Imperial. |
| `HS-AE-CIVIL-WAR-CHAMPIONS` | MR-042 | Keep Imperial-aligned handling unless final QA proves a gap. |
| `HS-MQ-PAARTHURNAX` | MR-044 | Reload and preserve Paarthurnax. |
| `HS-DG-BLOODLINE` | MR-045 | Reload and refuse Harkon's gift for Dawnguard. |
| `HS-AETHERIUM-FORGE` | MR-047 | Reload and craft Aetherial Crown. |
| `HS-DRAGONBORN-THIRSK-CHOICE` | MR-053 | Reload and complete Nord-side Thirsk. |
| `HS-DRAGONBORN-UNEARTHED-RALIS` | MR-055 | Spare Ralis on main save. |
| `HS-AE-GHOSTS-TEMPLE` | MR-057 | Reload and keep join/infiltrate path. |
| `HS-AE-BITTERCUP-ALTAR` | MR-058 | Reload and choose Fortune on main save. |
| `HS-TROPHY-MASTER-CRIMINAL` | MR-070 | Reload after trophy verification. |
| `HS-RIFT-FROST-LETRUSH` | MR-016 | Keep Frost on main save unless final QA proves a coverage gap. |
...
| `data/constraints/skill-perk-leveling-plan.md` | TB-027 block-level progression overlay for all-skills/all-perks, Legendary resets, training, crafting, investments, enchantment learning, alchemy effects, and underleveled fallbacks. TB-031E supplies source-selection defaults, TB-033 validated prototype integration, TB-034 placed the progression checkpoints, and exact reset counts/final skill-state validation remain TB-037. |
...
| Warnings are triggers, not route prose. | TB-032 records where a warning or save belongs; TB-034 placed those triggers into numbered route containers, and TB-035 expands them into guide text. |
...
| --- | --- | --- |
| Normal clearable locations | Route until the in-game `Cleared` tag appears; when a row is used for Delver, verify the `Dungeons Cleared` statistic unless the row is a documented exception. | TB-032 records concise warnings for quest/boss/report-back risks; TB-033 validated prototype handling; TB-034 placed the cleanup container; TB-037 validates final counters. |
| Angarvunde and Mistwatch | Route for dungeon, quest, word-wall, or checklist value, but do not count toward Delver. | TB-033 validated prototype handling; TB-034 placed the cleanup container; TB-037 validates final Delver padding without these rows. |
| Discoverable and duplicate markers | Source-listed discoverable markers can support `Explorer`; duplicate entrances are discovery candidates but share one parent clear. | TB-034 placed the discovery/clear cleanup container; TB-035/TB-037 choose final entrance order and validate `Locations Discovered`. |
...
| AE content locations and no-marker rows | Follow parent quest, property, branch, or content-package timing; no-marker rows are not Explorer padding. | TB-032/TB-034 placed warnings and prototype steps from parent content, not corridor distance alone. |
| Separate worldspaces | Skuldafn, Deadlands, Apocrypha, Soul Cairn, Forgotten Vale, and similar spaces need manual access/return/recovery planning. | TB-034 placed the separate-worldspace containers; TB-035 expands access/return notes and TB-037 validates route state. |
...
| --- | --- | --- |
| Side/misc/trophy counters | Track `Sideways`, `Hero of the People`, `Thief`, `Snake Tongue`, `Golden Touch`, `Dragon Hunter`, `Standing Stones`, and trophy-pop fallback saves as explicit checkpoints, not incidental expectations. | TB-032 records warnings and saves; TB-033 validated prototype handling; TB-034 placed checkpoints; TB-037 validates final counter totals and trophy pops. |
| Location counters | Route enough clearable/discoverable locations for `Delver`, `Explorer`, and Solstheim Explorer, but mark completion only after observed clear/discovery increments. | TB-031G has validated clear/discovery mechanics; TB-033 validated prototype handling; TB-034 placed the cleanup container; TB-037 validates final observed totals. |
| Skill-book and progression counters | Reader follows TB-031E copy/read policy and all 90 skill-book objectives; trophy check occurs after 50 unique titles. | TB-033 validated prototype handling; TB-034 placed the books/progression cleanup; TB-037 validates Reader plus final all-skills/all-perks state. |
| Radiant and faction counters | Thieves Guild restoration uses city tallies plus a separate 125-job total; Dawnguard `Lost Relic` records all filler radiants until all three relics are obtained. | TB-034 placed the loop containers; TB-037 verifies restoration, safe/display, relic, and filler records. |
| Activity systems | Hard Worker, Artificer, Fishing, cutting lumber, and milling are route-planning actions tied to existing support blocks; lumber and milling remain support-only unless final checklist proof needs cues. | TB-034 placed action checkpoints; TB-037 validates final checklist cues. |
| TB-031F/TB-031J source-readiness rows | `Rebuilding the Blades` and `Dragon Hunting` are branch-only Blades rows; `Archery Practice`, `Scare My Enemy`, `Firebrand Wine Case`, and `Map of Dragon Burials` now have source-backed main-route handling. TB-031J resolves the remaining queue: 75 main-route mappings, 1 BR-007 branch mapping for `Reclamation Priest's Journal (AE)`, and 2 explicit exclusions. | TB-033 validated branch/main continuity at the prototype level; TB-034 placed branch/main containers; TB-037 handles final checklist coverage. No `source_readiness_required` checklist rows remain. |
...
| Separate warnings from final pathing. | TB-032 records trigger placement; TB-034 supplies prototype step numbers; TB-035/TB-037 handle final road/entrance order, restock stops, and checklist cues. |
...
| `HS-AETHERIUM-FORGE` | Before forging the one Aetherial reward. | Audit Staff and Shield on branches, reload, craft Aetherial Crown on main save. | `SN-000099`, `SN-000105` |
...
| Collectibles, stones, shouts, and powers | Insert opportunistically when the corridor is already safe. TB-031F supplies counter checkpoint rules and TB-031G supplies location validation mechanics; TB-034 placed the prototype containers, while final checklist synchronization remains TB-037. |
...
* TB-031F has chosen counter/action policy, and TB-031G has validated location clear/discovery mechanics, duplicate/secondary markers, content-location treatment, and coordinate exception rules. TB-033 validated the prototype-level counter treatment; TB-034 placed the counter and cleanup containers; final entrance/path order and observed in-route totals still belong to TB-037.
...
* TB-032 has added the warning and hard-save overlay above, TB-033 has validated it in `validation-report-v0.md`, and TB-034 has turned those warning triggers into prototype step containers.
* TB-035/TB-037 must preserve the TB-033/TB-034 intake rules, including level gates, skill 100 recovery after Legendary resets, level 252+, all 251 perk ranks, investments, enchantment learning, alchemy effects, practical crafting systems, and Survival logistics.
