...
| MR-020 | G05 Aetherium setup | Start `Lost to the Ages`, collect Aetherium shards as route-safe, and hold the forge decision for the Dawnguard/later reward branch step. | Quest, Unique Item, Location | Do not craft the Aetherial item before `HS-DG-AETHERIUM-FORGE`. |
...
| MR-047 | G11 Aetherium Forge | At the forge, make `HS-DG-AETHERIUM-FORGE`; audit Staff and Shield branches, reload after each, then craft Aetherial Crown on the main save. | Branch, Artifact, Trophy | Keep only Aetherial Crown on canonical continuity. |
...
| `HS-DG-AETHERIUM-FORGE` | MR-047 | Reload and craft Aetherial Crown. |
