...
* Keep exact route timing, NPC safety, prerequisite validation, and bug handling in TB-032, TB-033, TB-034/TB-035, and the relevant constraint tables rather than this table.
