...
| `Hard Worker` | Perform all three player station actions explicitly. | Current v1 route uses Hulda/Whiterun wood chopping in the first city loop and Swindler's Den cooking during the Saadia route. The remaining action is a pickaxe-supported ore mine in the next economy/local-cleanup block; paid ore turn-in remains representative favor coverage, not required for the trophy. | SN-000089; SN-000103; SN-000113; SN-000126; SN-000127; SN-000133 |
