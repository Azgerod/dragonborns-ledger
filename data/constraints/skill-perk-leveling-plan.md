...
Trainer blocks, skill-book copy defaults, spell-tome source defaults, enchantment source families, alchemy ingredient source methods, investment circuit rules, crafting outputs, and reset distribution are selected by TB-031E. Final step placement, exact physical random/vendor source items, numeric reset counts, and final verification remain TB-033/TB-034 work.
...
| Illusion | 13 | Grows through utility/control spells and training. | Good late reset candidate after spell and cost support exist. | Master of the Mind is source-listed as a permanent effect after reset, but exact route use still needs final validation. | deferred_to_TB033_validation |
