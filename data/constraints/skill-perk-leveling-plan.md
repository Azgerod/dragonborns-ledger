...
Status: TB-027 complete as a block-level progression overlay; TB-031E source-selection overlay complete.

Scope: this is a constraint and progression-integration plan, not final route prose. It records hard requirements, risk boundaries, and writer recommendations for all-skills/all-perks, training, Legendary resets, crafting milestones, investments, material staging, and TB-027 route-block placement pressure. TB-031E source defaults now live in `progression-source-selection.md` and `progression-source-selections.csv`.

Trainer blocks, skill-book copy defaults, spell-tome source defaults, enchantment source families, alchemy ingredient source methods, investment circuit rules, crafting outputs, and reset distribution are selected by TB-031E. TB-033 validated the prototype-level progression integration; final step placement, exact physical random/vendor source items, numeric reset counts, and final verification remain TB-034/TB-037 work.

## TB-027 Completion Criteria

| Requirement | Status |
| --- | --- |
| Integrate skill/perk objective rows into route-block planning. | Complete. |
| Add Legendary reset policy. | Complete. |
| Add underleveled fallbacks for levels 8, 25, 27, 32, 36, 40, 46, 60, 78, 80, and 252. | Complete. |
...
| Resolve skill-book copies, recipes, source families, investment circuit, and checklist cues in TB-031E. | Complete: see `progression-source-selection.md` and `progression-source-selections.csv`. |
| Defer final route/progression validation to TB-034/TB-037 after TB-033 prototype validation. | Intentional. |
...
| Enchantment, alchemy, merchant-investment, and practical-crafting catalogs | Represented as completion scope and crafting power-curve constraints. TB-031E selects route-planning source families, discovery methods, investment circuit rules, and crafting outputs; final validation remains later work. |
...
| Skill books are progression tools and checklist rows. | Do not casually read every found skill book if it would waste high-skill value; use the TB-031E selected copies and read after Scholar's Insight unless final route validation documents a specific tradeoff. | SN-000051; SN-000103; SN-000120; SN-000126 |
...
| --- | --- | --- | --- | --- | --- |
| All skills to 100 | `OBJ-002425` through `OBJ-002443` | Every skill tree must reach 100, and the final completion state should leave every skill at 100 after any Legendary resets. | Route must include natural use, training, books, quest rewards, crafting, and/or grind blocks for all 18 skills. | SN-000081; SN-000119 | integrated_constraint |
| All skill perks | `OBJ-002444` through `OBJ-002462` | All 251 perk ranks across 180 perk nodes are required. Perks still require skill thresholds and prerequisite perks. | Perk allocation must be tracked; saved perk points are acceptable, but final cleanup must assign all ranks. | SN-000081; SN-000082; SN-000119 | integrated_constraint |
| Level 252 target | `OBJ-002463` | Level 252 supplies enough perk points for all 251 skill perk ranks. | The route must include a late all-perks leveling plan beyond normal quest progression. | SN-000119 | integrated_constraint |
| Legendary skill resets | `OBJ-002464` | Legendary resets are required for enough total levels, but each reset temporarily drops a skill to 15 and refunds that tree's perks. | Resets must be staged after combat readiness exists; reset skills must be recovered to 100 before final completion. | SN-000119 | integrated_policy |
...
| Skill books and quest skill rewards | `OBJ-000819` through `OBJ-000909`; quest support rows | One title/read or one quest reward should be counted deliberately; duplicate copies are not separate skill-book completion objectives. | Use TB-031E selected copy defaults, preserve Scholar's Insight timing, and keep quest-reward timing for final route placement. | SN-000103; SN-000119; SN-000120; SN-000126 | integrated_with_TB031E_source_selection |
| Skill Master trophy | `OBJ-002465` | First skill reaching 100 satisfies the trophy, but project scope exceeds it. | Check trophy when the first planned skill hits 100; continue all-skills plan. | SN-000103; SN-000081; SN-000119 | deferred_to_TB037_validation |
...
| Enchantment learning | `OBJ-002466` through enchantment rows | Learn all non-destructively learnable enchantments; preserve unique items rather than disenchanting them. | Use TB-031E selected nonunique/source-family rules; exact random/vendor physical item is verified in final route inventory. | SN-000083; SN-000121; SN-000122; SN-000126 | integrated_with_TB031E_source_selection |
| Alchemy effect discovery | Alchemy effect rows | Discover all source-listed ingredient effects across base game, DLC, and AE Creation ingredients. | Use TB-031E one-copy source methods and Experimenter 3 eating pass; quest/one-time ingredients require parent-quest preservation checks. | SN-000084; SN-000121; SN-000122; SN-000126 | integrated_with_TB031E_source_selection |
| Merchant investments | `OBJ-002717` through `OBJ-002750` | Source-listed available investments require Speech progression and the Investor perk; bugged/unknown rows remain audit-only until resolved. | Use TB-031E post-Investor regional circuit rules; avoid Speech resets before investments, sales, and Fence/Merchant support are complete. | SN-000085; SN-000108; SN-000120; SN-000122; SN-000126 | integrated_with_TB031E_source_selection |
| Practical crafting systems | `OBJ-002751` through `OBJ-002755`; support rows | Route must explicitly perform Artificer/Hard Worker actions and representative practical systems such as Atronach Forge, Staff Enchanter, and Imbuing Chamber. | Use TB-031E representative outputs and material staging; final route places the exact station visits and warnings. | SN-000086; SN-000103; SN-000121; SN-000122; SN-000126 | integrated_with_TB031E_source_selection |
...
| --- | ---: | --- | --- | --- | --- |
| Alteration | 14 | Likely grows through utility casting, mage questing, and training. | Good late reset candidate after spell access and Magicka/cost support exist. | Ritual spell objective requires Alteration 90; do not spend all high-value boosts before that gate. | integrated_policy |
| Conjuration | 16 | Grows through summons, bound weapons, soul trap support, and College work. | Good late reset candidate once strong spells and Magicka support exist. | Conjuration can preserve combat power through summons, but reset timing still needs safe combat support. | integrated_policy |
| Destruction | 17 | Grows through combat casting and training; slower if weapon-first route dominates. | Avoid repeated resets unless another offense plan is already strong. | Combat damage skill; resetting before hard fights is risky. | integrated_policy |
| Enchanting | 13 | Grows through disenchanting, enchanting crafted/looted items, recharging, and staff-enchanting support. | Candidate late reset only after knowledge capture and before final gear crafting; recover to 100 for Extra Effect final gear. | Disenchanting destroys source items; final dual-effect gear must be made after Extra Effect is available. | integrated_policy |
| Illusion | 13 | Grows through utility/control spells and training. | Good late reset candidate after spell and cost support exist. | Master of the Mind is source-listed as a permanent effect after reset, but exact route use still needs final validation. | deferred_to_TB037_validation |
| Restoration | 13 | Grows through healing, undead spells, Dawnguard content, and training. | Possible late reset, but avoid before Dawnguard/undead-heavy content if healing is core defense. | Restoration supports Survival no-health-regeneration pressure and vampire/undead contexts. | integrated_policy |
| Archery | 16 | Grows naturally if bows/crossbows are part of combat and Dawnguard work. | Avoid repeated resets until late; never reset alongside all other offense. | Weapon XP is not improved by tempering/enchantment damage; plan needs real target/combat volume. | integrated_policy |
| Block | 13 | Grows through shield/two-handed blocking in combat and training. | Avoid repeated resets; reset only when armor/offense can absorb the temporary loss. | Defensive skill reset can be dangerous on Legendary. | integrated_policy |
| Heavy Armor | 12 | Grows through being hit while wearing heavy armor and training. | Avoid repeated resets; not simultaneous with Light Armor and Block if defense depends on armor. | Final perk acquisition may require wearing full heavy sets for some perk utility. | integrated_policy |
| One-handed | 21 | Grows naturally if it is a primary combat style. | Avoid repeated resets unless alternate offense is established. | Highest rank count in the catalog; all weapon-style perks still required even if final build favors one style. | integrated_policy |
| Smithing | 10 | Grows through forging and tempering; material stockpiles and value matter. | Strong late reset candidate if materials and gold loop are planned, but avoid early max-crafting. | Arcane Blacksmith at 60 and Dragon Armor at 100 are important staged gates; Stalhrim and AE forging can be quest-gated. | integrated_policy |
| Two-handed | 19 | Grows naturally if used; otherwise likely needs training or deliberate combat blocks. | Avoid repeated resets unless alternate offense is established. | All style branches still need perks even if final build is not two-handed. | integrated_policy |
| Alchemy | 15 | Grows through potion/poison brewing, gardens, greenhouse/farm support, and ingredient discovery. | Strong late reset candidate after effect knowledge and material supply are secured. | Experimenter can reveal effects and then be reset without forgetting them; Fortify Restoration loop is not baseline. | integrated_policy |
| Light Armor | 10 | Grows through being hit while wearing light armor and training. | Avoid repeated resets; do not reset together with primary defensive alternatives. | Coordinate with Nightingale and armor-type reward behavior. | integrated_policy |
| Lockpicking | 11 | Grows from first-time lockpicking, broken picks, books, and training. | Do not use as repeated Legendary reset target; no reset or at most one late reset unless route proves enough new locks remain. | Previously picked locks do not grant XP again; Skeleton Key break prevention removes broken-pick XP. | integrated_policy |
| Pickpocket | 12 | Grows through pocketing/reverse-pickpocketing and can support Thief trophy. | Possible late reset candidate, but training/gold recovery loops are exploit-adjacent and not baseline. | Track 50 pockets for trophy separately from skill 100. | integrated_policy |
| Sneak | 13 | Grows through stealth movement and sneak attacks during route play. | Possible late reset candidate if stealth remains safe after reset. | Avoid early overleveling through isolated stealth grind before combat is stable. | integrated_policy |
| Speech | 13 | Grows through selling, buying, persuasion, bribe/intimidate checks, and training. | Prefer no repeated resets; if reset at all, do it after investments and major selling/fence work. | Investor investments persist, but losing Merchant/Fence temporarily changes sales routing. | integrated_policy |

## Legendary Reset Baseline

This is the TB-027 reset policy for the prototype, now made concrete by TB-031E's reset distribution table. Exact reset counts still cannot be finalized before TB-033 because they depend on final objective ordering, natural skill gains, training purchases, skill-book timing, Oghma timing, crafting batches, checklist cleanup, and final validation.
...
| --- | --- | --- | --- | --- |
| Enchantment learning | 54 main-route learnable effects; four unique-preservation exclusions; one unobtainable exclusion. | Accumulate disposable source items gradually; use TB-031E selected source families and validate final physical items before disenchanting. | SN-000083; SN-000122; SN-000126 | integrated_with_TB031E_source_selection |
| Alchemy effect discovery | 190 source-listed ingredient records across base game, DLC, and AE Creation content. | Acquire one copy using TB-031E source methods, then use the Experimenter 3 discovery pass unless final validation documents a safer exception. | SN-000084; SN-000121; SN-000122; SN-000126 | integrated_with_TB031E_source_selection |
| Merchant investments | 33 available investment rows; bugged/unknown rows remain audit-visible. | Do after Speech 70 and Investor, before any Speech reset, and while relevant merchants/replacements are alive and accessible; TB-031E maps the merchant circuit rules. | SN-000085; SN-000108; SN-000122; SN-000126 | integrated_with_TB031E_source_selection |
...
| Hearthfire construction | Build all three Hearthfire houses and all wings for Master Architect; material plan needed. | Stage materials through safe storage and transport infrastructure rather than carrying everything at once; TB-031E fixes this as G14 material/storage reconciliation. | SN-000030; SN-000105; SN-000117; SN-000121; SN-000126 | integrated_with_TB031E_source_selection |
| Atronach Forge | Practical system objective exists. | TB-031E representative output is Fire Salts, useful for Survival hot-soup support. | SN-000086; SN-000121; SN-000126 | integrated_with_TB031E_source_selection |
| Staff Enchanter | Practical system objective exists. | TB-031E representative output is Staff of Flames at normal Tel Mithryn access; do not rely on patched Myrwatch or Bloodchill XP behavior. | SN-000086; SN-000121; SN-000126 | integrated_with_TB031E_source_selection |
| Imbuing Chamber | Practical system objective exists. | TB-031E representative output is Mind Control Spider during White Ridge Barrow/Solstheim routing. | SN-000086; SN-000121; SN-000126 | integrated_with_TB031E_source_selection |
