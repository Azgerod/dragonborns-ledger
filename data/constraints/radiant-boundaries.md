...
| OBJ-000048 | Thieves Guild city influence jobs | Required gate | Complete at least 20 eligible Delvin/Vex jobs: five each in Markarth, Solitude, Whiterun, and Windhelm, then complete each city reputation quest. | Riften jobs do not count for restoration. Reject or manage non-restoration assignments, especially Raven Rock Bedlam. | SN-000112 | Required gate. |
| OBJ-000134-OBJ-000140 | Thieves Guild job types | Representative / completionist counter | Complete one of each job type for representative coverage. Separately, track total Delvin/Vex side jobs to 125 if full Guild shelf trophies and the Guildmaster safe remain in checklist scope; after 125, exclude repeats. | The first 20 eligible jobs satisfy restoration; the 125-job counter is a completionist display/safe boundary for TB-031C checklist review. | SN-000112 | Representative plus counter. |
...
| Thieves Guild 125 side jobs | TB-031C should decide whether shelf trophies and the 125-job safe become explicit checklist rows, optional appendix content, or a required completionist grind. |
