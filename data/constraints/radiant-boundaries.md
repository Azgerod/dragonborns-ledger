...
| OBJ-000102-OBJ-000108 | Companions post-`Take Up Arms` radiant pool | Representative / gate pool | Complete one instance of each type where route-feasible, with the required gate completions counting toward this pool. Hired Muscle is seed-sensitive and should be accepted if offered early, but TB-021 does not require a new-game restart solely to force it. | Do not grind arbitrary repeats after representative/gate coverage. TB-044 closes the ordinary pool after `Glory of the Dead` while retaining the Hired Muscle seed caveat. | SN-000112; SN-000249 | Representative with seed caveat. |
| OBJ-000109-OBJ-000111 | Companions Silver Hand window radiants | Windowed representative pool | Complete two total before `Blood's Honor`; all three cannot normally be completed in one playthrough. | Route chooses two and marks the unchosen third as one-save-limited, not a failure. | SN-000112; SN-000249 | Windowed limit. |
...
| OBJ-000114 | Dragon Seekers | Representative | Complete one instance after `Dragon Rising` is complete. | Repeats after one representative completion are excluded unless later reused as explicit trophy support. | SN-000112; SN-000249 | Representative. |
| OBJ-000115; OBJ-000116 | Companions parent radiant sets | Parent rows | No independent completion count beyond the Companions rows above. | Use as aggregate coverage labels only; TB-044 closes `OBJ-000115` through the child-row closeout and the Hired Muscle seed caveat. | SN-000112; SN-000249 | Covered by child rows. |
...
| OBJ-000048 | Thieves Guild city influence and side job counter | Required gate plus completionist counter | Complete at least 20 eligible Delvin/Vex jobs: five each in Markarth, Solitude, Whiterun, and Windhelm, then complete each city reputation quest. Continue tracking total Delvin/Vex side jobs to 125 for the final Guild display/safe boundary. | Riften jobs do not count for restoration. Reject or manage non-restoration assignments, especially Raven Rock Bedlam. Do not scatter jobs through early city visits before the late Thieves/Nightingale-state risk is cleared, except for the narrow Solitude 5/5 block required to complete Erikur's `The Dainty Sload` before `Bound Until Death`. | SN-000112; SN-000159 | Required gate plus required completionist counter after TB-031C. |
| OBJ-000134-OBJ-000140 | Thieves Guild job types | Representative / completionist counter | Complete one of each job type for representative coverage; use these job types as the selectable pool for the 125-job counter. After 125, exclude repeats. | The early Solitude exception can satisfy some job-type rows, but any unrepresented job types remain required in the later restoration/counter block. The first 20 eligible jobs satisfy restoration; the remaining counter work should be labelled completionist grind rather than faction-restoration work. | SN-000112; SN-000159 | Representative plus counter. |
| OBJ-000142 | Reparations | Excluded failure state | Do not intentionally offend the Thieves Guild to trigger the repair quest; preserve clean membership. | If it triggers from assault, theft, a guild-job killing, or the documented false-trigger bug, reload a clean save. Vex's 1,000-gold payment path is mistake recovery, not completion content. | SN-000208 | Excluded. |
...
| OBJ-000244 | Siddgeir `Kill the Bandit Leader` target handling | Finite named objective with bug-recovery exception | Complete Siddgeir's favor once through a safe target; do not accept Knifepoint Ridge on the final route. | Reload `HS-FALKREATH-LAND-JOB` only if Siddgeir assigns Knifepoint Ridge, because source pages show Knifepoint cannot be safely cleared before Boethiah or completed as a Jarl bounty once Boethiah's champion state is active. This exception is bug recovery, not ordinary target manipulation. | SN-000219 | Required once with Knifepoint exception. |
...
| OBJ-000381 | New Allegiances | Branch-only finite / representative | Complete at least one Volkihar conversion. Up to three distinct named targets may be pursued if the Volkihar branch checklist treats all conversions/coffins as required; duplicate-target offers should be avoided. | TB-031C/TB-029 keep one branch conversion as the current prototype scope unless TB-030/TB-033 checklist proof later escalates named variants. | SN-000114 | Branch policy handoff. |
...
| OBJ-000440; OBJ-000451; OBJ-000452; OBJ-001083 | Neloth Tel Mithryn research radiants | Finite named objectives with random target assignments | Complete `Azra's Staffs` once, then `Experimental Subject (B)`, then `Wind and Sand` once Destruction is at least 40; retrieve the `Wind and Sand` book through that quest. | Follow the active marker and do not reroll ordinary targets. Use `HS-TEL-MITHRYN-RESEARCH-RADIANTS` only for source-listed inaccessible-target recovery. | SN-000217 | Required once with active-marker handling. |
...
| No-journal activities | TB-031D chooses representative targets that also support Survival Mode travel, thaneship, relationship, or economy needs. |
