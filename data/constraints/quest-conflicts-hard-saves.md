...
| --- | --- | --- | --- | --- | --- | --- |
| Civil War faction commitment | OBJ-000072-OBJ-000101 | Imperial main route. Avoid finalizing route order until Season Unending and War Hero are validated. | Stormcloak Civil War branch from a pre-faction save; route only branch-exclusive sequence before reload. | HS-CW-BEFORE-FACTION-OATH | SN-000097 | Canonical decided; branch matrix later. |
| Dawnguard versus Volkihar at `Bloodline` | OBJ-000353, OBJ-000356, OBJ-000357, OBJ-000360, OBJ-000364, OBJ-000374-OBJ-000383 | Refuse Harkon's gift and continue Dawnguard. | Accept Harkon's gift and route Volkihar-exclusive quests, radiants, and rewards before reload. | HS-DG-BLOODLINE | SN-000097 | Canonical decided; branch matrix later. |
| Dark Brotherhood join versus destroy | OBJ-000053-OBJ-000068 | Kill a captive in the Abandoned Shack and join the Dark Brotherhood. Complete `Delayed Burial` before entering the Sanctuary if it will be included. | Kill Astrid, complete `Destroy the Dark Brotherhood!`, record branch-exclusive outcome and unavailable join-route rewards, then reload. | HS-DB-ABANDONED-SHACK | SN-000097, SN-000100 | Canonical decided; branch matrix later. |
| Paarthurnax and Blades/Greybeards conflict | OBJ-000019, OBJ-000317 | Preserve Paarthurnax. Use Greybeards support and do not kill him on the canonical save. | Kill Paarthurnax only on the branch after any intended Blades-exclusive setup; record lost Greybeards support and restored Blades support, then reload. | HS-MQ-PAARTHURNAX | SN-000097 | Canonical decided; branch matrix later. |
| Thirsk Mead Hall control | OBJ-000454-OBJ-000459 | Canonical side not yet selected. Do not help either side until the branch matrix chooses a default. | Route the opposite side from the same pre-choice save because Riekling and Nord outcomes are mutually exclusive. | HS-DRAGONBORN-THIRSK-CHOICE | SN-000034, SN-000099 | Needs default in TB-028. |
| Ghosts of the Tribunal heretics | OBJ-000615-OBJ-000620, OBJ-000740 | Join/infiltrate path is the provisional completionist default because it preserves armory access, crafting permissions, followers, and companion tasks. | Destroy the heretics as the alternate substantial branch; record lost armory-key/Skullcrusher access and alternate Temple state, then reload. | HS-AE-GHOSTS-TEMPLE | SN-000099 | Provisional default; confirm in TB-028. |
| Bittercup path choice | OBJ-000535, OBJ-000572-OBJ-000574, OBJ-000755 | Canonical path not yet selected. Do not use the altar until the branch matrix chooses Fortune, Power, or Nothing as the main continuity. | Branch the other two paths because each has exclusive follow-on rewards. | HS-AE-BITTERCUP-ALTAR | SN-000099 | Needs default in TB-028. |

## Artifact and Unique-Reward Outcome Saves

| Conflict or decision | Affected objectives | Canonical route | Branch route | Hard-save name | Source notes | Status |
| --- | --- | --- | --- | --- | --- | --- |
| `The Black Star` reward | OBJ-000165 | Provisional default: take the Black Star for utility unless TB-015 finds a trophy reason to prefer Azura's Star. | Branch Azura's Star and Aranea follower outcome if branch matrix treats it as substantial. | HS-DAEDRIC-BLACK-STAR | SN-000098 | Needs TB-015/trophy check. |
...
| `Ill Met By Moonlight` outcome | OBJ-000169 | Preserve a hard save before meeting Sinding in Bloated Man's Grotto. Main outcome waits for TB-015 because the dual-artifact route is source-listed but exploit-adjacent. | Branch single-outcome Sinding kill/spare variants and any artifact-maximizing dual outcome only after trophy policy is decided. | HS-DAEDRIC-HIRCINE-GROTTO | SN-000095, SN-000098 | Needs TB-015 and TB-028. |
...
| `Lost to the Ages` Aetherial reward | OBJ-000385, OBJ-001565, OBJ-001585, OBJ-001607 | Canonical Aetherial item not yet selected. Do not craft until the route chooses Crown, Shield, or Staff. | Branch other two craft rewards from the forge save if the branch matrix treats them as substantial unique rewards. | HS-DG-AETHERIUM-FORGE | SN-000099 | Needs default in TB-028. |
| `Promises to Keep` / Frost ownership | OBJ-001955, NPCOPT-000238 | Keep Frost on the main route if the unique mount checklist keeps Frost required. Prefer a save before meeting Louis with Frost. | Branch handing Frost to Louis or alternate Louis/Maven outcomes only if later checklist policy requires it. | HS-RIFT-FROST-LETRUSH | SN-000099 | Provisional main keep-Frost outcome. |
| `Unearthed` Ralis outcome | OBJ-000465, NPCOPT-000164 | Spare Ralis provisionally to preserve follower availability; remove/collect Hoarfrost without killing him if route permits. | Kill Ralis as an alternate justice/loot outcome branch. | HS-DRAGONBORN-UNEARTHED-RALIS | SN-000099 | Provisional default; TB-016 follower check. |
| `Forgotten Names` Velehk Sain outcome | OBJ-000764 | Canonical outcome not yet selected. Release gives the hidden treasure map; killing gives corpse loot. | Branch the opposite outcome if final checklist treats either reward set as required. | HS-COLLEGE-VELEHK-SAIN | SN-000099 | Needs default in TB-028. |
| `Battle of the Champions` side selection | OBJ-000579, OBJ-001350 | Imperial-aligned handling should match the Civil War main route unless TB-028 chooses pre-Civil-War neutral staging. Loot all equipment from the assigned chest and fallen champion. | Stormcloak-aligned staging belongs with the Stormcloak branch if it materially differs. | HS-AE-CIVIL-WAR-CHAMPIONS | SN-000099 | Needs branch-matrix placement. |

## Option-List Decisions

| Conflict or decision | Affected objectives | Canonical route | Branch route | Hard-save name | Source notes | Status |
| --- | --- | --- | --- | --- | --- | --- |
| `In My Time Of Need` | OBJ-000199 | Isolated moral/outcome choice; default not yet selected. | Do not full-branch unless checklist or later roleplay policy requires showing both endings. | Optional save before Saadia/Kematu handoff | SN-000099 | Option-list default later. |
| `The Blessings of Nature` | OBJ-000201 | Isolated Gildergreen outcome choice; default not yet selected. | Do not full-branch unless visual city-state or NPC preservation policy requires both. | Optional save before Eldergleam final choice | SN-000099 | Option-list default later. |
| Black Book power choices | OBJ-000418, OBJ-000420, OBJ-000441, OBJ-000460-OBJ-000462 | Pick practical defaults during skill/perk planning after changeability and usefulness are verified. | No full branch unless a power is proven irreversible for the route. | No hard save by default until a later pass proves an irreversible choice. | SN-000032, SN-000033 | Defer to TB-020. |
| Household and role assignments | OBJ-000408, OBJ-001945-OBJ-001954, NPC option rows | Use option lists with a recommended default for spouse, children, stewards, bards, carriage drivers, farmhands, followers, pets, and stable horses. | Do not full-branch isolated personal preference choices. | No hard save by default | SN-000067, SN-000099 | Option-list default later. |
...
| --- | --- | --- |
| Full branches with resolved canonical defaults | Civil War, Dawnguard, Dark Brotherhood, and Paarthurnax are ready for later branch-route construction. | SN-000097 |
| Full branches needing default selection | Thirsk, Bittercup, Lost to the Ages, and several side/AE reward choices need TB-028 default decisions before route prose. | SN-000099 |
