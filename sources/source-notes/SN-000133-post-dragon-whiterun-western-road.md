...
| SRC-000098 | Skyrim:Horse Armor - Steel | 2 - UESP | https://en.uesp.net/wiki/Skyrim:Horse_Armor_-_Steel | 2026-05-11 | Used for hostler acquisition, health boost, armor-removal inventory behavior, reapply cost, and 35-weight caveat. |
| SRC-000481 | Skyrim:Breezehome | 2 - UESP | https://en.uesp.net/wiki/Skyrim:Breezehome | 2026-05-13 | Used for `Bleak Falls Barrow` purchase prerequisite, 5,000-gold price, upgrade costs, and safe-container notes. |
| SRC-000072 | Skyrim:Tundra Homestead (place) | 2 - UESP | https://en.uesp.net/wiki/Skyrim:Tundra_Homestead_(place) | 2026-05-12 | Used for Tundra Homestead's 7,500-gold price, steward purchase source, fully furnished state, storage/crafting, garden/apiary, and family support. |
| SRC-000297 | Skyrim:Activities | 2 - UESP | https://en.uesp.net/wiki/Skyrim:Crafting | 2026-05-12 | Existing source for Hard Worker requiring wood chopping, ore mining, and cooking. |
| SRC-000304 | Skyrim:Mine Ore | 2 - UESP | https://en.uesp.net/wiki/Skyrim:Mine_Ore | 2026-05-12 | Existing source for mining requiring a pickaxe and the station action being sufficient for the Hard Worker mining component. |
...
UESP's Swindler's Den page places bandits in the cave normally and Kematu with Alik'r warriors during `In My Time Of Need`. It identifies a `Thief` skill-book copy on a bedroll, a cooking pot in the bandit camp route, and an iron ore vein near the shortcut loop. The guide uses the cooking pot now because it is on the routed quest path, but leaves mining for a later pass because the route has not yet sourced a pickaxe. The same page currently marks the location as not reliably clearable and notes a clear-tag bug, while the earlier harvested location catalog treated Swindler's Den as source-listed clearable. The guide therefore discovers and sweeps the cave for the quest but does not claim Delver/clear credit until location-counter QA resolves the clear-state conflict.

UESP's Horses page lists Whiterun Stables as selling a black horse through Skulvar Sable-Hilt or Jervar and gives 1,000 gold as the price for purchasable horses. Existing Survival route notes select the Whiterun horse as the first bought-horse default because horses improve travel and carry handling under Survival Mode. The guide buys the horse here before the western road trip rather than leaving it as a later support abstraction.

UESP's Elven and Steel Horse Armor Creation pages state that horse armor is obtained via hostlers, grants a temporary 1,000-health boost, cannot be worn with saddles, and is returned to inventory if removed. Elven Horse Armor weighs 25; Steel weighs 35. Since the player is already buying a compatible active horse from a hostler and Elven is the lighter removed-item risk, the guide applies Elven now and holds Steel for a later storage-supported stable visit.
