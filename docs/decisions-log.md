...
This log records user-resolved project decisions that shape the guide. `docs/guide-specification.md` remains canonical; if this file and the specification diverge, update this file to match the specification.

## 2026-05-11 - Initial Scope Decisions

| Area | Resolved decision |
| --- | --- |
| Platform | PS4. |
...
| Main-route Dawnguard side | Dawnguard. |
| Main-route Dark Brotherhood path | Join. |
...
| Checklist relationship | The guide must map spreadsheet-tracked objectives to route steps, branch steps, option-list notes, appendices, or explicit exclusions. |

## 2026-05-11 - Branch Policy Decisions

| Area | Resolved decision |
| --- | --- |
| Branch routing model | Use selective branch routing. |
| Branch order | Create a named hard save, play the alternate branch first, reload, then continue the canonical main route. |
| Branch scope | Include only branch-exclusive content and avoid duplicating main-route objectives. |
