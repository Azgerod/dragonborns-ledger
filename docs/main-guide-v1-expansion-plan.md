...
| TB-035-MR-031 | MR-031 - Northern Preflight | G08 north preflight | Player-facing section is now `Dawnstar, Vaermina, And Cold-Weather Setup`: cooks hot food at Dawnstar Sanctuary, crafts Camping Supplies at Dawnstar using Windpeak/Rustleif support, routes Rustleif, Wayfinder, conditional Frida target recording, Silus's museum start, full `Waking Nightmare`/Nightcaller Temple/Skull branch handling, and Skald's giant-bounty target; property, investments, and target-dependent completions remain concretely staged. | Done |
...
| TB-035-MR-033 | MR-033 - Dawnstar, Pale Blade, And Heljarchen | G08 Pale/Dawnstar reshaped | Player-facing section is now `Dawnstar, Pale Blade, And Heljarchen`: Kharjo target protection, Leigelf/Karl, Unholy Vigil, Saturalia/Reindeer, Yngvild, Conjure Haunting Spirit fixed-source revision, High Gate/Anska/Vokun, Lord Stone/Frostmere/Pale Blade, all four Pale giant camps, Treasure Map VI and cache, Skald bounty, Thane of the Pale, Gregor, Heljarchen Hall purchase, foundation, and Land Baron. | Done |
...
| TB-035-MR-036 | MR-036 - Labyrinthian And The Eye Of Magnus | G09 College finale | Continue from active `The Staff of Magnus` through Labyrinthian, Staff of Magnus acquisition, `The Eye of Magnus`, College restoration, Arch-Mage state, and immediate College-crisis cleanup. | Pending |
| TB-035-MR-037 | MR-037 - Gauldur Legend Finale | G09 Gauldur finale | Remaining `Forbidden Legend` work after Folgunthur/Mikrul and Saarthal/Jyrik: Geirmund's Hall, Reachwater Rock, final Gauldur rewards; stale level-36 checkpoint removed because route already passed the threshold. | Pending |
| TB-035-MR-037A | MR-037A - College Side Content And Rituals | G09 College side/outcome | Remaining College side quests, radiants, ritual spell quests, master spells, selected spell-tome purchases, and Oghma/Septimus timing; `Forgotten Names`/Velehk is already handled in MR-032. | Pending |
